...
names(ratings_table) <- c("Proposal: 1",2:8)
set.alignment("right")
...
```{r}
fit_mb(rankings=ToyData1$rankings,ratings=ToyData1$ratings,M=ToyData1$M,method="ASTAR")
ASTAR(rankings=ToyData1$rankings,ratings=ToyData1$ratings,M=ToyData1$M)
```
